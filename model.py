...
class Teas(db.Model):
    ...
    flavors = db.relationship('FlavorProfiles', secondary="assocTeaFlavors", back_populates='teas')
...
class FlavorProfiles(db.Model):
    ...
    teas = db.relationship('Teas', secondary="assocTeaFlavors", back_populates='flavors')
